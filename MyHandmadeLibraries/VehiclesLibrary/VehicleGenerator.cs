...
namespace Vehicles
{
    public class VehicleGenerator<T>
    {
        #region DataLists
...
//Random Generator, LEET Edition^^
    ...
    //Land
    internal static Car CarGenerator()
    {
        //Randomize it!
    ...
    internal static Motorcycle MotorcycleGenerator()
    {
        //Randomize it!
        Dictionary<string, decimal> stats = 
    ...
    internal static Truck TruckGenerator()
    {
        //Randomize it!
        Dictionary<string, decimal> stats =
    ...
    internal static Bycicle BycicleGenerator()
    {
        //Randomize it!
        bool yesNo = false; 
    ...
    //Air
    internal static Helicopter HelicopterGenerator()
    {
        //Randomize it!
        Dictionary<string, decimal> stats =
    ...
    internal static Plane PlaneGenerator()
    {
        //Randomize it!
        Dictionary<string, decimal> stats =
    ...
    //Sea
    internal static Boat  BoatGenerator()
    {
        //Randomize it!
        bool yesNo = false; 
    ...
    internal static Ship ShipGenerator()
    {
        //Randomize it!
        Dictionary<string, decimal> stats =
            BasicStats(new int[] { 80, 340 },
    ...
    //Space
    internal static Rocket RocketGenerator()
    {
        //Randomize it!
        Dictionary<string, decimal> stats =
    ...
    internal static Satellite SatelliteGenerator()
    {
        //Randomize it!
        Dictionary<string, decimal> stats =
